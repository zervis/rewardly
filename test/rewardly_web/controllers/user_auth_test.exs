defmodule RewardlyWeb.UserAuthTest do
  use RewardlyWeb.ConnCase, async: true

  alias Rewardly.Users
  alias RewardlyWeb.UserAuth
  import Rewardly.UsersFixtures

  @remember_me_cookie "_rewardly_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RewardlyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RewardlyWeb.Endpoint.subscribe(live_socket_id)
