defmodule Rewardly.Users.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :credits, :integer, default: 50
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Rewardly.Repo)
  ...
  """
  def valid_password?(%Rewardly.Users.User{hashed_password: hashed_password}, password)
