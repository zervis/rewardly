...
config :rewardly,
  ecto_repos: [Rewardly.Repo]

# Configures the endpoint
config :rewardly, RewardlyWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: RewardlyWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Rewardly.PubSub,
  live_view: [signing_salt: "ZJfMJxs5"]
